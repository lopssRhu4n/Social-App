<template>
  <div
    class="row-span-6 col-span-11 class flex justify-center items-center flex-col gap-3"
  >
    <h1 class="text-white text-3xl cursor-default">
    ...
    <p class="cursor-default text-white">
      Feito com VueJs, Tailwind e Typescript.
    </p>
  </div>
</template>
